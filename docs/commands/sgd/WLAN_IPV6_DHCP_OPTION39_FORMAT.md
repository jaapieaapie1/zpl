...
Name or FQDN) in DHCPv6 with a WLAN connection. The value is a string up to 127 characters, and the
...
```
       ! U1 setvar "wlan.ipv6.dhcp.option39_format" "value"
...
```
       ! U1 getvar "wlan.ipv6.dhcp.option39_format"
...
```
       ! U1 setvar "wlan.ipv6.dhcp.option39_format" "printer2"
